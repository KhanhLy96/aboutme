...
<div class="container-fluid py-5" id="testimonial">
    <div class="container">
        <div class="position-relative d-flex align-items-center justify-content-center">
            <h1 class="display-1 text-uppercase text-white" style="-webkit-text-stroke: 1px #dee2e6;">Review</h1>
            <h1 class="position-absolute text-uppercase text-primary">People Say</h1>
        </div>
        <?php
        $query="SELECT * FROM review ";
        $result=$mysqli->query($query);
        while($arReview=mysqli_fetch_assoc($result)){
        ?>
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="owl-carousel testimonial-carousel">
                    <div class="text-center">
                        <i class="fa fa-3x fa-quote-left text-primary mb-4"></i>
                        <h4 class="font-weight-light mb-4">aaaaaaaaaaaaaaa</h4>
                        <img class="img-fluid rounded-circle mx-auto mb-3" src="template/aboutme/img/testimonial-1.jpg" style="width: 80px; height: 80px;">
                        <h5 class="font-weight-bold m-0"><?php echo $arReview['name'];?></h5>
                        <span><?php echo $arReview['position'];?></span>
                    </div>
                    <?php } ?>
                </div>
            </div>
