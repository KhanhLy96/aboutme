...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
            ...
            <span class="ms-1 font-weight-bold text-white">Admin Site</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link text-white " href="/quality/">
                    ...
                    <span class="nav-link-text ms-1">Manage quality</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white " href="./billing.html">
                    ...
                    <span class="nav-link-text ms-1">Manage skill</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="./virtual-reality.html">
                    ...
                    <span class="nav-link-text ms-1">Manage project</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="./notifications.html">
                    ...
                    <span class="nav-link-text ms-1">Manage review</span>
                </a>
            </li>
